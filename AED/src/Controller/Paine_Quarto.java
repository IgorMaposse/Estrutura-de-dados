...
public class Paine_Quarto extends JPanel implements ActionListener{
	...
	private JTextField text_id,text_posicao;
	...
	public Paine_Quarto() {
		...
		label_posicao=new JLabel("Posicao");
		...
		botaoRegistar=new JButton("Eliminar Cliente");
		...
		text_posicao=new JTextField(20);
	...
	//	painel1.add(label_nome);
		...
		painel3.add(label_posicao);
		painel3.add(text_posicao);
